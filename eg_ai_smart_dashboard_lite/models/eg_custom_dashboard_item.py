...
class EgCustomDashboardItem(models.Model):
    ...
    record_sort = fields.Selection([('ASC', 'Ascending'), ('DESC', 'Descending')], string='Record Sort')
    ...
    @api.depends('ir_model_id', 'label_model_field_id', 'date_record_filter_type', 'date_filter_field', 'record_limit')
