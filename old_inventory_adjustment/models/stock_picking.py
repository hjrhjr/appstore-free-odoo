...
class StockMoveLine(models.Model):
    ...
    def _action_done(self):
        ...
        for line in self:
            print('self.date', line.date)
            (line - ml_to_delete).with_context(bypass_reservation_update=True).write({
...
class StockMove(models.Model):
    ...
    def _action_done(self, cancel_backorder=False):
        ...
        print(moves_todo,'moves_todo')
        for move in moves_todo:
            moves_todo.write({'state': 'done', 'date': move.date})
...
class StockPickingLine(models.Model):
    ...
    def _get_move_values(self, qty, location_id, location_dest_id, out):
        self.ensure_one()
        print('5555555555', self.inventory_id)
        print('33333', self.inventory_id.date)
        return {
...
class StockPicking(models.Model):
    ...
    is_old_transfer = fields.Boolean(string='Old Adjustment')
